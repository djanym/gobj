...
$db_config = array(
	'user' => 'root',
	'pass' => '',
	'name' => '161104_letysouq',
	'host' => 'localhost'
);

define('SITEURL', 'http://letysouq.loc/adminy4/' );
define('AUTH_COOKIE',	'sofisdf7897234dfg&&12123QQworuowirua89asddoa78999as98d0OIdqweuao');
define('AUTH_SALT',		'NVuvis8A?,/as)(ASU)D34HSDf8&^S$%^>#<#=M3< spdoadi(*0as98d0OIduao');
//define('SITE_SALT',		'sdfjklASD(*U34ASD*&%&^Gugasd76sdfs**TD*AISJD>?<Masd>?asdjk(8sa6S');
//define('POST_SALT',		's_12879SD(*UHJ34D*&sdfd&^$8&IFSDHIUH8934*AISJD>?<Masd>?Sasdjlk*s');
//define('GET_SALT',		'sdf-dfkD(*UHJASD34%&^G932)a:KLDF(&*ASTD*AISJD>?<Masd>?SASDUUIOa6');
//define('COOKIE_SALT',	'sdfjkh238476534!34!!!>>>>sdfudshkfKJHSDAKSJDH2837463847<<<AS&<<<');
